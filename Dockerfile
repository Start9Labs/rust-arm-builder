...
RUN ln -s /usr/aarch64-linux-gnu/lib/libavahi-client.so /usr/lib/gcc-cross/aarch64-linux-gnu/9/libavahi-client.so
...
RUN ln -s /usr/aarch64-linux-gnu/lib/libavahi-common.so /usr/lib/gcc-cross/aarch64-linux-gnu/9/libavahi-common.so
...
RUN ln -s /usr/aarch64-linux-gnu/lib/libdbus-1.so.3 /usr/lib/gcc-cross/aarch64-linux-gnu/9/libdbus-1.so.3
RUN ln -s /usr/aarch64-linux-gnu/lib/libdbus-1.so /usr/lib/gcc-cross/aarch64-linux-gnu/9/libdbus-1.so
...
RUN ln -s /usr/aarch64-linux-gnu/lib/libsystemd.so.0 /usr/lib/gcc-cross/aarch64-linux-gnu/9/libsystemd.so.0
RUN ln -s /usr/aarch64-linux-gnu/lib/libsystemd.so /usr/lib/gcc-cross/aarch64-linux-gnu/9/libsystemd.so
...
RUN ln -s /usr/aarch64-linux-gnu/lib/liblzma.so.5 /usr/lib/gcc-cross/aarch64-linux-gnu/9/liblzma.so.5
RUN ln -s /usr/aarch64-linux-gnu/lib/liblzma.so /usr/lib/gcc-cross/aarch64-linux-gnu/9/liblzma.so
...
RUN ln -s /usr/aarch64-linux-gnu/lib/liblz4.so.1 /usr/lib/gcc-cross/aarch64-linux-gnu/9/liblz4.so.1
RUN ln -s /usr/aarch64-linux-gnu/lib/liblz4.so /usr/lib/gcc-cross/aarch64-linux-gnu/9/liblz4.so
...
RUN ln -s /usr/aarch64-linux-gnu/lib/libgcrypt.so.20 /usr/lib/gcc-cross/aarch64-linux-gnu/9/libgcrypt.so.20
RUN ln -s /usr/aarch64-linux-gnu/lib/libgcrypt.so /usr/lib/gcc-cross/aarch64-linux-gnu/9/libgcrypt.so
...
RUN ln -s /usr/aarch64-linux-gnu/lib/libgpg-error.so.0 /usr/lib/gcc-cross/aarch64-linux-gnu/9/libgpg-error.so.0
RUN ln -s /usr/aarch64-linux-gnu/lib/libgpg-error.so /usr/lib/gcc-cross/aarch64-linux-gnu/9/libgpg-error.so
...
RUN ln -s /usr/aarch64-linux-gnu/lib/libselinux.so.1 /usr/lib/gcc-cross/aarch64-linux-gnu/9/libselinux.so.1
RUN ln -s /usr/aarch64-linux-gnu/lib/libselinux.so /usr/lib/gcc-cross/aarch64-linux-gnu/9/libselinux.so
...
RUN ln -s /usr/aarch64-linux-gnu/lib/libpcre.so.3 /usr/lib/gcc-cross/aarch64-linux-gnu/9/libpcre.so.3
RUN ln -s /usr/aarch64-linux-gnu/lib/libpcre.so /usr/lib/gcc-cross/aarch64-linux-gnu/9/libpcre.so
